  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full mt-4.5 py-3.25 px-5 bg-rose font-vt text-[1.2rem] text-black-m font-bold cursor-pointer relative overflow-hidden transition-colors outline-[1.8px] -outline-offset-8  hover:text-rose
          ${btnState === "success"
